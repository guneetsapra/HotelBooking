...
import com.hotelbooking.ReviewsListActivity;
...
public class AdminHotelswithReviews extends BaseAdapter {
    List<HotelPojo> hotelInfo;
    Context con;
    String url= "http://cegephotel.com/hotel/";

    public AdminHotelswithReviews(List<HotelPojo> hotelInfo, Context con) {
    ...
    public View getView(final int pos, View view, ViewGroup viewGroup) {
        ...
        View hotels = obj1.inflate(R.layout.adapter_adminviewrevieshotelslist, null);
        ...
        TextView tvReviews=(TextView)hotels.findViewById(R.id.tvReviews);
        tvReviews.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(con, ReviewsListActivity.class);
